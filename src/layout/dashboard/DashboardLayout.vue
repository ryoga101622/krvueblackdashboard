  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/AI" :name="$t('AI')" icon="tim-icons icon-world"/>
        <sidebar-link to="/Chat" :name="$t('Chat')" icon="tim-icons icon-chat-33"/>
        <sidebar-link to="/Geo" :name="$t('Geo')" icon="tim-icons icon-square-pin"/>
      </template>
    </side-bar>
